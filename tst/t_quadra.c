...
void test_deve_criar_quadra_com_dados_geometricos(void)
{
    ...
    TEST_ASSERT_EQUAL_DOUBLE(10.0, obter_x_quadra(quadra));
    TEST_ASSERT_EQUAL_DOUBLE(20.0, obter_y_quadra(quadra));
    TEST_ASSERT_EQUAL_DOUBLE(30.0, obter_largura_quadra(quadra));
    TEST_ASSERT_EQUAL_DOUBLE(40.0, obter_altura_quadra(quadra));
...
void test_deve_definir_estilo_da_quadra(void)
{
    ...
    TEST_ASSERT_EQUAL_DOUBLE(2.5, obter_espessura_quadra(quadra));
...
void test_deve_ter_estilo_padrao(void)
{
    ...
    TEST_ASSERT_NOT_NULL(quadra);
    TEST_ASSERT_EQUAL_DOUBLE(1.0, obter_espessura_quadra(quadra));
...
void test_deve_retornar_valores_neutros_para_quadra_nula(void)
{
    ...
    TEST_ASSERT_EQUAL_DOUBLE(0.0, obter_x_quadra(NULL));
    TEST_ASSERT_EQUAL_DOUBLE(0.0, obter_y_quadra(NULL));
    TEST_ASSERT_EQUAL_DOUBLE(0.0, obter_largura_quadra(NULL));
    TEST_ASSERT_EQUAL_DOUBLE(0.0, obter_altura_quadra(NULL));
    TEST_ASSERT_EQUAL_DOUBLE(0.0, obter_espessura_quadra(NULL));
